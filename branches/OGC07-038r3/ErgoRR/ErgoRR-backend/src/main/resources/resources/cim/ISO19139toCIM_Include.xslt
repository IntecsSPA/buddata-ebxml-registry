...
<xsl:stylesheet version="2.0" xmlns:saxon="http://saxon.sf.net/" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:rim="urn:oasis:names:tc:ebxml-regrep:xsd:rim:3.0" xmlns:wrs="http://www.opengis.net/cat/wrs/1.0" xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:gmx="http://www.isotc211.org/2005/gmx" xmlns:srv="http://www.isotc211.org/2005/srv" xmlns:gml="http://www.opengis.net/gml" xmlns:xlink="http://www.w3.org/1999/xlink">
	...
	<xsl:variable name="cimObjectTypeUrnPrefix"><xsl:text>urn:ogc:def:objectType:OGC-CSW-ebRIM-CIM::</xsl:text></xsl:variable>

	<xsl:variable name="applicationObjectType">urn:ogc:def:ebRIM-ObjectType:OGC:Application</xsl:variable>
	...
	<xsl:variable name="metadataInformationObjectType"><xsl:value-of select="concat( $cimObjectTypeUrnPrefix, 'MetadataInformation' )"/></xsl:variable>
	...
	<!-- replace urn:x-ogc:specification:csw-ebrim:ClassificationScheme:ISO-19119:Services -->
	<xsl:variable name="servicesClassificationScheme">			   	
		<xsl:text>urn:ogc:def:classificationScheme:OGC-CSW-ebRIM-CIM::ISO-19119:2003:Services </xsl:text>
	</xsl:variable>
