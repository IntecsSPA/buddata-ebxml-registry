...
public class RegistryErrorList {
    ...
    public boolean isSetRegistryError() {
        return ((this.registryError!= null)&&(!this.registryError.isEmpty()));
    }

    public void unsetRegistryError() {
    ...
    public boolean isSetHighestSeverity() {
        return (this.highestSeverity!= null);
    }
