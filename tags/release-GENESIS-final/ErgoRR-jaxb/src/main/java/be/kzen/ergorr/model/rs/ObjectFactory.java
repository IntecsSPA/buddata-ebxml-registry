 ...
 * generated in the be.kzen.ergorr.model.rs package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: be.kzen.ergorr.model.rs
     * 
     */
