...
public class EarthObservationResultPropertyType {
    ...
    @XmlElementRef(name = "EarthObservationResult", namespace = "http://earth.esa.int/eop", type = JAXBElement.class)
    protected JAXBElement<? extends be.kzen.ergorr.model.eo.eop.EarthObservationResultType> earthObservationResult;
     ...
     *     
     */
    public JAXBElement<? extends be.kzen.ergorr.model.eo.eop.EarthObservationResultType> getEarthObservationResult() {
     ...
     *     
     */
    public void setEarthObservationResult(JAXBElement<? extends be.kzen.ergorr.model.eo.eop.EarthObservationResultType> value) {
        this.earthObservationResult = ((JAXBElement<? extends be.kzen.ergorr.model.eo.eop.EarthObservationResultType> ) value);
    }
