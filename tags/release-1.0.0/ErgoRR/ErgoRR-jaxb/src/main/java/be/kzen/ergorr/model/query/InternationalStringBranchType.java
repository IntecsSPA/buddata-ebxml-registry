    ...
    extends BranchType
{
    ...
    public boolean isSetLocalizedStringFilter() {
        return ((this.localizedStringFilter!= null)&&(!this.localizedStringFilter.isEmpty()));
    }

    public void unsetLocalizedStringFilter() {
