  ...
  /* this.securityConfigurationPortal={
                ...
                items:[{
                    ...
                    items:[{
                        xtype: 'form',
			bodyStyle: 'padding: 10px;',
                        title: this.loc.getLocalMessage('securityTitlePanel'),
                        buttons:[ {
                                text: this.loc.getLocalMessage('reloadButton'),
                                handler: function(){
                                    reloadSecurity();
                        ...
                        items: [{
                            xtype: 'fieldset',
                            title: this.loc.getLocalMessage('enableSecurityGroup'),
                            bodyStyle:'padding:5px;',
                            items: [
                            {
                                xtype: 'checkbox',
                                id:'enableSecurityCheckbox',
                                fieldLabel:this.loc.getLocalMessage('enableSecurityLabel'),
                                width:.9,
                                handler: function(){
                            ...
                            xtype: 'fieldset',
                            title: this.loc.getLocalMessage('keyStoreGroup'),
                            bodyStyle:'padding:5px;',
                            autoWidth:true,
                            items: [{
                                xtype: 'textfield',
                                id:'keyStorePathField',
                                fieldLabel:this.loc.getLocalMessage('keyStorePathLabel')
                            },{
                                xtype: 'textfield',
                                id:'KeyStorePasswordField',
                                fieldLabel:this.loc.getLocalMessage('keyStorePasswordLabel')
                            },{
                                xtype: 'textfield',
                                id:'keyStoreCertAliasField',
                                fieldLabel:this.loc.getLocalMessage('certificateAliasLabel')
                            },{
                                xtype: 'textfield',
                                id:'keyStoreCertPasswordField',
                                fieldLabel:this.loc.getLocalMessage('certificatePasswordLabel')
                            } ]
                        },{
                            xtype: 'fieldset',
                            title: this.loc.getLocalMessage('truststoreGroup'),
                            bodyStyle:'padding:5px; width:90%',
                            autoWidth:true,
                            items: [{
                                xtype: 'textfield',
                                id:'trustStorePathField',
                                fieldLabel:this.loc.getLocalMessage('trustStorePathLabel')
                            },{
                                xtype: 'textfield',
                                id:'trustStorePasswordField',
                                fieldLabel:this.loc.getLocalMessage('trustStorePasswordLabel')
                            }]
                        }]
