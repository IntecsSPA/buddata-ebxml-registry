...
<xsl:transform xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:sml="http://www.opengis.net/sensorML/1.0.1"
               version="2.0">
    <!-- output parameters -->
    ...
    <!-- (ID) PREFIXES -->
    <xsl:variable name="systemIdentifier" select="//sml:System/sml:identification/sml:IdentifierList/sml:identifier/sml:Term[@definition='urn:ogc:def:identifier:OGC::uniqueID' or @definition='urn:ogc:def:identifier:OGC:1.0:uniqueID']/sml:value" />
