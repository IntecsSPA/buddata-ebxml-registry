...
public class HistoryPropertyType {
    ...
    @XmlElement(name = "AbstractTimeSlice", required = true)
    protected List<AbstractTimeSliceType> abstractTimeSlice;
    @XmlAttribute
     ...
     * {@link AbstractTimeSliceType }
     * 
     * 
     */
    public List<AbstractTimeSliceType> getAbstractTimeSlice() {
        if (abstractTimeSlice == null) {
            abstractTimeSlice = new ArrayList<AbstractTimeSliceType>();
        }
