    ...
    extends RegistryObjectType
{
    ...
    private static final String otUrn = "urn:oasis:names:tc:ebxml-regrep:ObjectType:RegistryObject:ServiceBinding";
    ...
    public boolean isSetSpecificationLink() {
        return ((this.specificationLink!= null)&&(!this.specificationLink.isEmpty()));
    }

    public void unsetSpecificationLink() {
