    ...
    extends RegistryObjectType
{
    ...
    public boolean isSetUsageParameter() {
        return ((this.usageParameter!= null)&&(!this.usageParameter.isEmpty()));
    }

    public void unsetUsageParameter() {
    ...
    public boolean isSetServiceBinding() {
    ...
    public boolean isSetSpecificationObject() {
        return (this.specificationObject!= null);
    }
