 ...
 *         &lt;element ref="{http://earth.esa.int/hma}parentIdentifier" minOccurs="0"/>
 *         &lt;element ref="{http://earth.esa.int/hma}acquisitionType"/>
 *         &lt;element ref="{http://earth.esa.int/hma}acquisitionSubType" minOccurs="0"/>
 *         &lt;element ref="{http://earth.esa.int/hma}productType"/>
 *         &lt;element ref="{http://earth.esa.int/hma}status"/>
 *         &lt;element name="downlinkedTo" type="{http://earth.esa.int/hma}DownlinkInformationArrayPropertyType" minOccurs="0"/>
 *         &lt;element name="archivedIn" type="{http://earth.esa.int/hma}ArchivingInformationArrayPropertyType" minOccurs="0"/>
 *         &lt;element ref="{http://earth.esa.int/hma}imageQualityDegradation" minOccurs="0"/>
 *         &lt;element ref="{http://earth.esa.int/hma}imageQualityDegradationQuotationMode" minOccurs="0"/>
 *         &lt;element ref="{http://earth.esa.int/hma}histograms" minOccurs="0"/>
 *         &lt;element ref="{http://earth.esa.int/hma}composedOf" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element ref="{http://earth.esa.int/hma}subsetOf" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element ref="{http://earth.esa.int/hma}linkedWith" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="processing" type="{http://earth.esa.int/hma}ProcessingInformationPropertyType" minOccurs="0"/>
 *         &lt;element name="vendorSpecific" type="{http://earth.esa.int/hma}SpecificInformationArrayPropertyType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
