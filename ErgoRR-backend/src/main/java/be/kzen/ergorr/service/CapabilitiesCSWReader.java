 ...
 */
public class CapabilitiesCSWReader {

    private static Logger logger = Logger.getLogger(CapabilitiesCSWReader.class.getName());
    ...
    private static final String CAPABILITIES_FILE = "/resources/CapabilitiesCSW.xml";

    private RequestContext requestContext;

    public CapabilitiesCSWReader() {
    }

    public CapabilitiesCSWReader(RequestContext requestContext) {
