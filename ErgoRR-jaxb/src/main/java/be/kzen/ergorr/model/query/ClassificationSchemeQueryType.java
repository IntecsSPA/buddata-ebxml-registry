    ...
    extends RegistryObjectQueryType
{
    ...
    public boolean isSetChildrenQuery() {
        return ((this.childrenQuery!= null)&&(!this.childrenQuery.isEmpty()));
    }

    public void unsetChildrenQuery() {
    ...
    public boolean isSetNodeTypeQuery() {
