    ...
    extends RegistryObjectQueryType
{
    ...
    public boolean isSetSpecificationLinkQuery() {
        return ((this.specificationLinkQuery!= null)&&(!this.specificationLinkQuery.isEmpty()));
    }

    public void unsetSpecificationLinkQuery() {
