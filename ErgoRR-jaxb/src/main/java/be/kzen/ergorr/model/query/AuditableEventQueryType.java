    ...
    extends RegistryObjectQueryType
{
    ...
    public boolean isSetAffectedObjectQuery() {
        return ((this.affectedObjectQuery!= null)&&(!this.affectedObjectQuery.isEmpty()));
    }

    public void unsetAffectedObjectQuery() {
    ...
    public boolean isSetEventTypeQuery() {
        return (this.eventTypeQuery!= null);
    }
