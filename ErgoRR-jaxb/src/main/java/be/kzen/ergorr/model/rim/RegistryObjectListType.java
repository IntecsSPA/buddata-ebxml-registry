...
public class RegistryObjectListType {
     ...
     * {@link JAXBElement }{@code <}{@link be.kzen.ergorr.model.rim.ExtrinsicObjectType }{@code >}
     ...
     * {@link JAXBElement }{@code <}{@link be.kzen.ergorr.model.wrs.WrsExtrinsicObjectType }{@code >}
    ...
    public boolean isSetIdentifiable() {
        return ((this.identifiable!= null)&&(!this.identifiable.isEmpty()));
    }

    public void unsetIdentifiable() {
